...
local onUse_mod_bombs = function( _user, _targetTile )
{
	...
	::Time.scheduleEvent(::TimeUnit.Real, delayPerDistance * tileDistance, this.onApplyAcid.bindenv(this), {
		Skill = this,
		User = _user,
...
this.rf_sling_acid_flask_skill_mb <- ::inherit("scripts/skills/actives/throw_acid_flask", obj);