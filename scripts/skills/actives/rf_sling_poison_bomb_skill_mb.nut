local obj = ::Reforged.InheritHelper.slingItemSkill("throw_poison_bomb_skill");
...
this.rf_sling_poison_bomb_skill_mb <- ::inherit("scripts/skills/actives/throw_poison_bomb_skill", obj);